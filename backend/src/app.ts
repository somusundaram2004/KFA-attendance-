...
app.use('/attendance', authenticate, verifyHandshake, authorizeStaffBatch, attendanceRoutes);

app.use('/api/students', authenticate, verifyHandshake, authorizeStaffBatch, studentRoutes);
app.use('/students', authenticate, verifyHandshake, authorizeStaffBatch, studentRoutes);

app.use('/api/staff', authenticate, verifyHandshake, staffRoutes);
app.use('/staff', authenticate, verifyHandshake, staffRoutes);

app.use('/api/batches', authenticate, verifyHandshake, authorizeStaffBatch, batchRoutes);
app.use('/batches', authenticate, verifyHandshake, authorizeStaffBatch, batchRoutes);

app.use('/api/grades', authenticate, verifyHandshake, gradeRoutes);
app.use('/grades', authenticate, verifyHandshake, gradeRoutes);
